...
:::{admonition} No such file or directory?
:class: tip
...
:::{figure} fig/macos_volume_mounting.svg
:alt: Volume mounting on macOS diagram
:width: 800px

*Volume mounting from host to VM to container*
:::
